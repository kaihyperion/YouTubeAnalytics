...
app.add_page("📆 Posting Gap Analysis (DOW analysis+)", script1.app)
app.add_page("🗃 CATEGORIZATION/RETENTION PERFORMANCE ANALYSIS", script23.app)
# app.add_page("Reporting API", reporting.app)
app.add_page("📊 Content Type Analysis", script2.app)
app.add_page("🧾 Retention Performance Analysis", script3.app)
